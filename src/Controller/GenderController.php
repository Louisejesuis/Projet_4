...
class GenderController extends Controller
{
    ...
    {
        return $this->render('gender/index.html.twig', ['genders' => $genderRepository->findAll()]);
    }
    ...
    {
        return $this->render('gender/show.html.twig', ['gender' => $gender]);
    }
    ...
    public function edit(Request $request, Gender $gender): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('gender_edit', ['id' => $gender->getId()]);
        }
